    ...
    return (
        <div className="cart__wrapper">
            <div className="cart__top">
                <NavLink className="cart__toHome" to="/"><img src={prev} alt="" /></NavLink>
                <button onClick={onClearCart} className="remove__cart">
            ...
            {totalCount ? (
                <div>
                    <div className="cart__items">
                        {addedPizzas.map(obj => <CartItem name={obj.name} id={obj.id} price={obj.price} type={obj.type} img={obj.imgUrl} size={obj.size} totalPrice={items[obj.id].totalPrice} totalCount={items[obj.id].items.length} onRemoveItem={onRemoveItem} onPlus={onPilusCart} onMinus={onMinusCart} />)}
                    </div>
                    <div className="cart__footer">
                        <div className="cart__count">amount of food: {totalCount}</div>
                        <div className="cart__totalprice"> total price: {totalPrice} </div>
                    </div>
                    <div className="cart__pay">Pay</div>
                </div>
            ) : (
